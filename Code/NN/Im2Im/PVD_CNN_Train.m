function PVD_CNN = PVD_CNN_Train(Training_Mode,net)
	...
	switch(S.Im2Im)
		...
		case 3 % pixelLabelDatastore.
			...
			Output_Train = pixelLabelDatastore(Train_Set{:,2},["BG","Neuron"],[0,255]);
			Output_Test = pixelLabelDatastore(Test_Set{:,2},["BG","Neuron"],[0,255]);
			
			% Combine input and output data into a "pixelLabelImageDatastore":
			Train_Set = pixelLabelImageDatastore(Input_Train,Output_Train);
			Test_Set = pixelLabelImageDatastore(Input_Test,Output_Test);
