function [deepnet,y] = Autoencoders_NN(Training_Frames,Training_Classes,Testing_Frames,Testing_Classes,Frame_Half_Size)
	...
	rng('default');
	hiddenSize1 = 100; % Number of neurons in hidden layer 1. Default: 100.
	hiddenSize2 = 100; % Number of neurons in hidden layer 2. Default: 50.
