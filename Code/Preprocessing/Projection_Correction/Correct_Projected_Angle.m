function [Angle_Corrected,Medial_Angle_Corrected_Diff,Angle_Medial,Angle_Corrected_Medial] = Correct_Projected_Angle(A,A0,At)
	...
	Vp_M = Vp*rotz(A0*180/pi); % Clockwise rotation (around z) of the vector such that the tangent of the reference vector is the new x-axis.		
	...
	Vr_XY = Vr_M_XY*rotz(-A0*180/pi); % And finally rotate around Z back such that the medial axis is the new x-axis.		
	...
	Angle_Corrected = mod(atan2(Vr_XY(2),Vr_XY(1)),2.*pi); % A corrected in radians in Cartesian axes.
